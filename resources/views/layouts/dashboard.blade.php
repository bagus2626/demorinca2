  ...
  <nav class="navbar navbar-expand-lg bg-transparent position-absolute w-100">
    <div class="container-fluid">
        ...
        <div class="d-lg-none ms-auto">
            <button class="btn btn-outline-custom"><a class="nav-link" href="{ route('login') }}">Login</a></button>
        </div>
        ...
        <div class="collapse navbar-collapse" id="navbarContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item"><a class="nav-link" href="{{ route('dashboard.contact') }}">Kontak</a></li>
        ...
        <div class="container">
            <div class="card consultant-card text-bg-dark">
                ...
                <div class="card-img-overlay d-flex flex-column justify-content-end">
                  ...
                  <div class="flex ">
                    <a class="consultant-btn-fill me-3" href="https://wa.me/6281328256653">
                ...
                <div class="col-md-3 mb-4">
                    ...
                    <ul class="footer-links ms-md-5">
                        <li>
                            ...
                            <a href="https://wa.me/6281328256653" class="fw-light">0813-2825-6653</a>
                        </li>
                        <li>
